...
export const GET: APIRoute = async ({ site }) => {
	...
	const body = [
		...
		'without the ".md" suffix. Canonical URLs carry no trailing slash: a',
		'slashed URL 307-redirects to the slash-less one.',
		'',
		'This lists the documentation, blog and blueprint twins. Marketing and',
		'listing pages also have twins, listed in llms.txt and advertised by the',
