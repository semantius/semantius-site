...
- **[Agent Skills Installation →](/docs/reference/agent-skills/installation)**: For coding agents, install the Semantius CLI and skills alongside these MCP connectors.
- **[Models Overview →](/docs/reference/models)**: Learn what the connectors are reading and writing.
- **[Templates →](/docs/reference/models/templates)**: Deploy a curated semantic model and start chatting with it through the MCP connectors.
