...
| `+`, `-`, `*`, `/`, `%` | Arithmetic. |
| `cat` | String concatenation (treats `null` as `"null"`, unlike the Semantius [`concat`](/docs/reference/business-logic/extensions) extension). |
