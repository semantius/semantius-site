...
The `/semantic-model-optimizer` [agent skill](/docs/reference/agent-skills) closes the loop in the [model lifecycle](/docs/reference/models). It reads a live Semantius module and writes a `*-semantic-model.md` file that is byte-compatible with the format the [Business Analyst](/docs/reference/models/create) produces and the [Deployer](/docs/reference/models/deploy) consumes. From there you can audit it, refine it, and ship the corrected version back.
