...
The `/semantic-model-deployer` [agent skill](/docs/reference/agent-skills) takes a `*-semantic-model.md` file (one you [created](/docs/reference/models/create), one of the [Templates](/docs/reference/models/templates), or one [optimized](/docs/reference/models/optimize) from a live module) and materializes it in a live Semantius instance. It is safe to re-run: every pass inspects what is already there and applies only the delta.
